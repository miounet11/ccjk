...
const githubRepo = 'miounet11/ccjk';
const siteTitle = 'CCJK';
const siteDescription = 'Production-ready AI dev environment documentation for Claude Code';
  ...
  [
    {
      ...
      items: [{ text: 'Project Introduction', link: 'index' }],
    },
    {
...
const jaSidebar: DefaultTheme.SidebarItem[] = createSidebar(
  [
    {
      text: 'プロジェクト紹介',
      items: [{ text: 'プロジェクト紹介', link: 'index' }],
    },
    {
      text: 'はじめに',
      items: [
