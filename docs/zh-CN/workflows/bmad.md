...
- **CCJK 工作流**：[工作流系统](../features/workflows.md)
...
> 💡 **提示**：BMad 工作流是 CCJK 工作流生态的重要组成部分，特别适合企业级项目的规范化开发。建议在项目早期就引入 BMad 工作流，以获得最大的收益。结合 CCJK 的其他工作流和工具，可以构建完整的 AI 驱动开发流程。