...
| `essentialTools` | 是 | `init-project.md`、`feat.md` | `init-architect`、`get-current-datetime`、`planner`、`ui-ux-designer` | `/ccjk:init-project`、`/ccjk:feat` | `/prompts:init-project`、`/prompts:feat` |
