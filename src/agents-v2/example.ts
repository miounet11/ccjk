...
import type { Agent, AgentSkill, BroadcastMessage, RequestMessage, ResponseMessage } from './index.js'
import {
...
async function example4_PriorityQueue() {
  ...
  try {
    ...
    const messages = [
      { id: 'msg-1', type: 'event' as const, from: 'example', event: 'task', data: 'low priority task', payload: 'low priority task', priority: 'low' as const, timestamp: new Date().toISOString() },
      { id: 'msg-2', type: 'event' as const, from: 'example', event: 'task', data: 'urgent task', payload: 'urgent task', priority: 'urgent' as const, timestamp: new Date().toISOString() },
      { id: 'msg-3', type: 'event' as const, from: 'example', event: 'task', data: 'normal task', payload: 'normal task', priority: 'normal' as const, timestamp: new Date().toISOString() },
      { id: 'msg-4', type: 'event' as const, from: 'example', event: 'task', data: 'high priority task', payload: 'high priority task', priority: 'high' as const, timestamp: new Date().toISOString() },
    ]
