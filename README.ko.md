<!--
  ...
  Description: CCJK는 Claude Code를 위한 가장 강력한 확장 툴킷입니다. 11+ AI 에이전트, LLM 기반 코드 감사, 스킬 자동화, 플러그인 시스템을 제공합니다. 원클릭 설정.
-->
...
> **🚀 주요 아키텍처 업그레이드 - 통합 템플릿 시스템**
> - 🏗️ **템플릿 통합** - `templates/common/` 공유로 코드 재사용성 향상
> - 🔄 **듀얼 코드 도구 지원** - Claude Code + Codex 통합 설정
> - ✨ **sixStep 워크플로우 강화** - 사용자 승인, 타임스탬프, 명확한 단계
> - 🛡️ **CCR 프록시 수정** - ANTHROPIC_AUTH_TOKEN 충돌 자동 제거
> - 🌐 **4개 언어 지원** - English, 中文, 日本語, 한국어
>
> **⭐ GitHub에서 스타를 눌러주세요!**

<br/>

> 💡 **한 줄 명령으로 AI 코딩 경험을 슈퍼차지하세요**
>
> ```bash
> npx ccjk
> ```
...
**CCJK (Claude Code 진쿠)** 는 Claude Code를 단순한 AI 어시스턴트에서 **완전한 AI 개발팀**으로 변환합니다. 11+ 전문 AI 에이전트, 지능형 자동화, 세계 최초의 LLM 기반 코드 감사기로 더 빠르게 더 나은 코드를 작성할 수 있습니다.
...
| 에이전트 | 기능 | 사용 예시 |
|---------|------|----------|
| 🛡️ **보안 전문가** | 취약점 발견, OWASP 검사 | "이 인증 코드의 보안 문제 검토" |
| ⚡ **성능 전문가** | 속도 최적화, 메모리 절감 | "앱이 왜 느린가요?" |
...
| `ccjk doctor` | 환경 검사 | 문제 발생 시 |
| `ccjk upgrade` | 모든 것 업데이트 | 최신 상태 유지 |
